...
\usepackage[sorting=none,hyperref,backend=bibtex,backref,backrefstyle=none]{biblatex}
...
% start START
\setcounter{page}{0}
\include{sections/chapter_Intro}
\include{sections/chapter_SM}
\include{sections/chapter_DarkMatter}
\include{sections/chapter_ATLASDetector}
%\include{sections/chapter_NSW}
\include{sections/chapter_common_analysis_items}
\include{sections/chapter_analysismethod}  
\include{sections/chapter_dijet}
%\include{sections/chapter_SearchForResolvedDijetISR} % edit and add from int note.
%\include{sections/chapter_SearchForBoostedDijetISR} % edit and add from int note
\include{sections/chapter_dimuon}
\include{sections/chapter_topo}
%\include{sections/chapter_FutureResonanceFinding}

op% All fonts, including those for sub- and superscripts, must be 10
...
%\include{sections/chapter_NSW} 1 
%\include{sections/chapter_SearchForResolvedDijetISR} 2
%\include{sections/chapter_SearchForBoostedDijetISR} 3
%\include{sections/chapter_SearchForDimuon} 4 
%\include{sections/chapter_FutureResonanceFinding} 5

...
%\include{sections/chapter_analysismethod.tex} % extract from analysis method 
%%%%\include{sections/chapter_NSW}
%%%\include{sections/chapter_SearchForResolvedDijetISR} % include from paper 
%%%%\include{sections/chapter_SearchForBoostedDijetISR} % edit and add from int note
%\include{sections/chapter_dijet} % edit and add from int note
%\include{sections/chapter_SearchForDimuon}

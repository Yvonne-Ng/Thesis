...
%d to find the smallest window that can be used that still provide enough signal sensitivity for the search.
...
%The statistics testing of a hypothesis is related to the significance quantity Z:
%
%\begin{equation}
% Z= \Phi^{-1}(1-p) 
